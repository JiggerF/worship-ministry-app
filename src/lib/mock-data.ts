...
export const MOCK_ROSTER: SundayRoster[] = [
  {
    ...
    setlist: [
      ...
      { id: "s3", sunday_date: "2026-02-15", song_id: "sg3", position: 3, song: { id: "sg3", title: "Build My Life", artist: "Pat Barrett", status: "published", categories: ["gospel_salvation"], youtube_url: "https://youtube.com/watch?v=example3", scripture_anchor: null, created_at: "", chord_charts: [{ id: "cc3", song_id: "sg3", key: "D", file_url: null, storage_path: null, created_at: "" }] } },
    ],
  },
  {
    date: "2026-02-22",
